...
public class GrabPack1 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (Input.GetMouseButtonDown(1) && canInstantiate)
        {
            Instantiate(prefabToInstantiate, barrel.position, barrel.rotation);
            audio.PlayOneShot(fire, 7.1f);
            flarehand.SetBool("flare", true);
    ...
    IEnumerator Cooldown()
    {
        ...
        // Set the cooldown flag back to true
        canInstantiate = true;
